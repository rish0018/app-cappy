...
export default function OnboardingScreen() {
  return (
    <ImageBackground
      source={require("../assets/background_constelation.jpg")}
      resizeMode="cover"
      className="flex-1"
    >
      <View className="flex-1 bg-primary-500/80">
        <SafeAreaView className="flex-1">
          <View className="flex-1 items-center justify-center px-2xl">
            {logoSource ? (
              <Image
                source={logoSource}
                className="mb-xl h-32 w-32 rounded-full"
                resizeMode="contain"
              />
            ) : (
            ...
            <Text className="mt-md text-center text-lg text-primary-100">
              Your calm, patient guide to learning American Sign Language
              fingerspelling.
            </Text>
