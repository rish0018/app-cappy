...
export default function LoginScreen() {
  ...
  async function handleLogin() {
    ...
    try {
      ...
      setFormNotice("We couldn't sign you in just yet. Let's give that another try.");
      ...
      <KeyboardAvoidingView className="flex-1" behavior={Platform.OS === "ios" ? "padding" : undefined}>
        <ScrollView className="flex-1 px-2xl" contentContainerStyle={{ paddingBottom: 32 }} keyboardShouldPersistTaps="handled">
          <View className="mb-xl mt-2xl items-center">
            {logoSource ? (
              <Image source={logoSource} className="mb-md h-16 w-16 rounded-full" resizeMode="contain" />
            ) : (
            ...
            <Text className="text-center text-2xl font-bold text-neutral-800">Welcome back</Text>
